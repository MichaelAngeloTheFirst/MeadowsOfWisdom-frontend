...
export function SimpleRegisterForm() {
  ...
  const setAccessToken = useStore(useAuthStore, (state) => state.setAccessToken);
  const setRefreshToken = useStore(useAuthStore, (state) => state.setRefreshToken);
        ...
        <Checkbox
          label={
            <Typography variant="small" color="gray" className="flex items-center font-normal">
              I agree the
              <Link href="#" className="font-medium transition-colors hover:text-blue-500">
